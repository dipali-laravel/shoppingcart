...
Route::get('/', 'App\Http\Controllers\IController@home');
...
Route::get('/new-products', 'App\Http\Controllers\IController@new_productoption');
Route::get('/special-products', 'App\Http\Controllers\IController@special_products');
Route::get('/all-products', 'App\Http\Controllers\IController@full_products');
