...
class IController extends Controller
{
    public function home(){
        ...
        $product = Product::all();
        return view('enest/home',compact('category','product'));
    }
    ...
    public function new_productoption(){
        $category = Category::all();
        $data=Product::orderby('id','desc')->get();  
        return view('enest/new-productoption',compact('data','category'));
    }
    ...
    public function full_products(){
        ...
        return view('enest/full-products',compact('data','category'));
    }
